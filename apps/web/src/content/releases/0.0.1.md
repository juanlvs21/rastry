...
The repository currently requires Bun 1.4.0 or newer. Desktop packaging and the v0.2 workflow are tracked separately from this foundation release. See the [installation guide](/docs/install/) and [changelog source](https://github.com/juanldev/rastry/blob/main/CHANGELOG.md).
